...
{
    public class SettingService : NetCommunitySolutionAppServiceBase, ISettingService
    {
        #region Fields
        ...
        public void DeleteSetting(string key)
        {
            ...
            _cacheManager.GetCache(string.Format(NetCommunitySolutionConsts.CACHE_SETTINGS, key))
